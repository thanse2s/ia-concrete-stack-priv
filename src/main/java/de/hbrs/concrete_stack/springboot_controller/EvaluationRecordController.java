...
public class EvaluationRecordController {
    ...
    @PostMapping("/{id}")
    public void createEvaluationRecord(@RequestBody long id ,EvaluationRecord evaluationRecord) {
        service.create(id,evaluationRecord);
    }

    @PutMapping("/{id}")
    public void updateEvaluationRecord(@RequestBody long id,EvaluationRecord evaluationRecord){
